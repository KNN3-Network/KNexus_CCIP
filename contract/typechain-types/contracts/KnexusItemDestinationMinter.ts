...
export interface KnexusItemDestinationMinterInterface extends Interface {
  getFunction(
...
export interface KnexusItemDestinationMinter extends BaseContract {
  connect(runner?: ContractRunner | null): KnexusItemDestinationMinter;
  waitForDeployment(): Promise<this>;

  interface: KnexusItemDestinationMinterInterface;
