...
task(
  ...
  .setAction(
    async (taskArguments: TaskArguments, hre: HardhatRuntimeEnvironment) => {
      ...
      const myNftFactory: KnexusCCIP__factory =
        (await hre.ethers.getContractFactory("KnexusCCIP")) as KnexusCCIP__factory;
      const myNft: KnexusCCIP = await myNftFactory.deploy();
