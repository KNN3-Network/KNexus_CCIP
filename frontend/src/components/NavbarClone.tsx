...
export default function NavbarClone(props: any) {
  ...
  return (
    <nav className="flex justify-between items-center fixed w-full z-50 laptop:py-[40px] mobile:py-[10px] bg-[#000] shadow-2xl">
      <div
        className="laptop:h-[60px] mobile:h-[40px] w-full absolute top-0 left-0"
        style={{
          background:
            "linear-gradient(180deg, #D5F95F 0%, rgba(170, 255, 0, 0) 100%)",
        }}
      ></div>
      <Image
        src={Logo}
      ...
      {!showNavMobile ? (
        ...
        >
          <div className="w-[30px] h-[5px] rounded-full bg-[#D5F95F] m-[5px]"></div>
          <div className="w-[30px] h-[5px] rounded-full bg-[#D5F95F] m-[5px]"></div>
          <div className="w-[30px] h-[5px] rounded-full bg-[#D5F95F] m-[5px]"></div>
        </div>
      ) : (
      ...
      <ul
        ...
        mobile:hidden mobile:flex-col mobile:justify-center mobile:items-center mobile:text-center mobile:text-[#000] mobile:fixed mobile:top-0 mobile:bottom-0 mobile:left-0 mobile:right-0 mobile:bg-[#D5F95F] mobile:mr-0 text-xl z-40`
          ...
          mobile:flex mobile:flex-col mobile:justify-center mobile:items-center mobile:text-center mobile:text-[#000] mobile:fixed mobile:top-0 mobile:bottom-0 mobile:left-0 mobile:right-0 mobile:bg-[#D5F95F] mobile:mr-0 text-xl`
        }
      >
        ...
        {/* <li className='mobile:w-full laptop:w-auto cursor-pointer'>
          <button onClick={() => window.open("https://knexus.staging.knn3.xyz/")}
            className='font-eurostile rounded-full relative
            mobile:text-black mobile:w-full mobile:py-4 mobile:bg-block mobile:text-2xl
            laptop:text-xl laptop:bg-transparent laptop:text-[#D5F95F] laptop:py-1 laptop:px-6'
            disabled={true}
          >
            Pandora Draw
            <span className='laptop:bg-[#D5F95F] laptop:text-[#000] mobile:text-[#D5F95F] inline-block mobile:bg-[#000] text-black absolute laptop:top-0 w-[38px] text-[12px] rounded-full' style={{height: 12, lineHeight: '12px'}}>soon</span>
          </button>
        </li> */}
        <li className="mobile:w-full laptop:w-auto cursor-pointer">
          <button
